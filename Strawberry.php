<?php
	...
	{	
		...
		{
			$_SESSION["Strawberry_pro"] = "Strawberry";
			$_SESSION["Strawberry_quant"] = $_POST["quantity"];
			$_SESSION["Strawberry_img"] = "images/category-2.jpg";
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/category-2.jpg" class="image-popup"><img src="images/category-2.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
